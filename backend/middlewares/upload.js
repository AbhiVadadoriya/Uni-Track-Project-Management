...
const fileFilter = (req, file, cb) => {
    ...
    const allowedExtensions = [
        ".pdf", ".doc", ".docx", ".ppt", ".pptx", ".zip", ".rar", ".jpg", ".jpeg", ".png", ".gif", ".txt", ".js", ".css", ".html", ".json"
    ...
    if(allowedTypes.includes(file.mimetype) || allowedExtensions.includes(fileExt)){
        ...
        cb(new Error("Invalid file type. Only PDF, DOC, DOCX, PPTX, ZIP, RAR, IMAGES, and code files are allowed."
        ),
            false
    );
    }
